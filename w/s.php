...
<title><?php echo $aik['sitename'];?>手机在线电视直播</title>
...
<div class="tz">
	<div class="marquee-box">
	    ...
	    <?php echo $aik['sitename'];?>公告:在线成人影音播放平台！功能仅支持手机在线观看或者下载官方APP播放！成人影音频道更新资源，观看有问题请联系官方站长！更多精彩内容，请访问智云解析官网：https://github.com/zhizg/b，反馈交流请加入官方QQ交流群，或者关注官方博客！
		</marquee>
	...
	<p class="center" style="font-size:14px;"><span style="color:#fd891a;">提示您：</span>功能仅支持手机在线播放或下载官方APP观看</p>
	<p class="center"></p>
</div>
</div>
<iframe src="se.html" marginheight="10" marginwidth="20" frameborder="0" scrolling="no" width=100% height=610 id="iframepage" name="iframepage"></iframe>
<hr>
<br>
</div><div>
  <br>
  <div align="center" class="STYLE2"> </div>
   ...
   <tbody>
     <tr>
	<div class="ts">
<td bgcolor="#ACA899"><center><a href="javascript:location.reload()" onclick="_dct_("dh_m_phb");" class="aRank"><span><font size=4>☞点我刷新-清除缓存-重新加载☜</span></a><br/></center></td>
	<div class="ts">
    </tr>
  </tbody></table>
<table border=2 width=100%>
