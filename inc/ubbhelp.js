...
var email_help = "插入邮件地址\n\n插入邮件地址连接。\n例如：\n[email]webmaster@fir8.net[/email]\n[email=webmaster@fir8.net]Loveyuki[/email]";
...
var link_help = "插入超级链接\n\n插入一个超级连接。\n例如：\n[url]http://www.fir8.net[/url]\n[url=http://www.fir8.net]eblog[/url]";
var link_normal = "请输入链接显示的文字，如果留空则直接显示链接。";
var link_normal_input = "请输入 URL。";
var image_help = "插入图像\n\n在文本中插入一幅图像。\n例如：[img]http://www.fir8.net/images/logo.gif[/img]";
var image_normal = "请输入图像的 URL。";
var flash_help = "插入 Flash\n\n在文本中插入 flash 动画。\n例如：[swf]http://www.fir8.net/images/banner.swf[/swf]";
var flash_normal = "请输入 Fash 动画的 URL。";
var wma_help = "插入音频文件\n\n在文本中插入音频文件。\n例如：[wma]http://www.fir8.net/music/music.mp3[/wma]";
var wma_normal = "请输入音频文件的 URL。";
var wmv_help = "插入视频文件\n\n在文本中插入视频文件。\n例如：[wmv]http://www.fir8.net/mtv/mtv.wmv[/wmv]";
var wmv_normal = "请输入视频文件的 URL。";
var code_help = "插入代码\n\n插入程序或脚本原始代码。\n例如：[code]Response.Write(这里是 eblog)[/code]";
