...
E_D("replace into `go_config` values('1','web_name','掌门人夺宝-惊喜无限','网站名');");
E_D("replace into `go_config` values('2','web_key','夺宝|妃子云购|夺宝系统|购物|一元购物','网站关键字');");
E_D("replace into `go_config` values('3','web_des','是一种全新的购物方式,是时尚、潮流的风向标,能满足个性、年轻消费者的购物需求,由泸州特云宝网络科技有限公司注入巨资打造的新型购物网。\n','网站介绍');");
E_D("replace into `go_config` values('4','web_path','http://www.yungou.com','网站地址');");
...
E_D("replace into `go_config` values('19','qq','185616883','qq');");
E_D("replace into `go_config` values('20','cell','QQ185616883','联系电话');");
E_D("replace into `go_config` values('21','web_logo','banner/20160221/90302196038830.png','logo');");
E_D("replace into `go_config` values('22','web_copyright','Copyright © 2011 - 2015, 版权所有 粤ICP备09213115号-1','版权');");
E_D("replace into `go_config` values('23','web_name_two','夺宝','短网站名');");
E_D("replace into `go_config` values('24','qq_qun','123456|456789','QQ群');");
