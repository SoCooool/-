...
E_D("replace into `go_template` values('group.index.html','yungou','论坛首页');");
E_D("replace into `go_template` values('group.list.html','yungou','论坛列表页');");
E_D("replace into `go_template` values('group.nei.html','yungou','论坛内容');");
E_D("replace into `go_template` values('group.right.html','yungou','论坛右边');");
...
E_D("replace into `go_template` values('member.joingroup.html','yungou','加入的论坛');");
...
E_D("replace into `go_template` values('member.topic.html','yungou','论坛话题');");
...
E_D("replace into `go_template` values('single_web.fund.html','yungou','单页_夺宝基金');");
