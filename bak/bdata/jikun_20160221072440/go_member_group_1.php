...
E_D("replace into `go_member_group` values('1','夺宝新手','0','500',NULL,'N');");
E_D("replace into `go_member_group` values('2','夺宝小将','501','1000',NULL,'N');");
E_D("replace into `go_member_group` values('3','夺宝中将','1001','3000',NULL,'N');");
E_D("replace into `go_member_group` values('4','夺宝上将','3001','6000',NULL,'N');");
E_D("replace into `go_member_group` values('5','夺宝大将','6001','20000',NULL,'N');");
E_D("replace into `go_member_group` values('6','夺宝将军','20001','40000',NULL,'N');");
