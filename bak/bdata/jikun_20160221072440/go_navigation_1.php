...
E_D("replace into `go_navigation` values('1','0','所有商品','index','/goods_list','Y','2');");
E_D("replace into `go_navigation` values('2','0','新手指南','index','/single/newbie','Y','2');");
E_D("replace into `go_navigation` values('3','0','夺宝圈','foot','/group','Y','2');");
E_D("replace into `go_navigation` values('4','0','关于夺宝','foot','/help/1','Y','1');");
...
E_D("replace into `go_navigation` values('17','0','夺宝QQ群','foot','/group_qq','Y','2');");
