...
E_C("CREATE TABLE `go_member_del` (
  ...
  `addgroup` varchar(255) DEFAULT NULL COMMENT '用户加入的论坛组1|2|3',
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COMMENT='会员表'");
E_D("replace into `go_member_del` values('116','','cuiyinming@163.com','','e10adc3949ba59abbe56e057f20f883e','上海市上海市,116.231.208.63','photo/member.jpg','','1',NULL,'999.00','1','-1','0','-1','cuiyinming@163.com','20','20','1',NULL,'1443444476','','','0','0');");
E_D("replace into `go_member_del` values('120','我是用户名1','12345678@qq.com','13354545875','e10adc3949ba59abbe56e057f20f883e',NULL,'photo/member.jpg',NULL,'1',NULL,'0.00','1','1','0','-1',NULL,'0','0','0',NULL,'1443527317','','','0','1');");
