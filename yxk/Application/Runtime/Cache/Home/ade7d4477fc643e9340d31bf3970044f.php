            	...
            	<div class="box">
						...
						<div class="box-content">
							...
							<div class="row">
                                ...
                                <?php if(is_array($tp)): $i = 0; $__LIST__ = $tp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-3" style="height:220px;">
									...
									<div class="wrap-vid">
										...
										<div class="zoom-container">
											...
											<div class="zoom-caption">
												...
												<span><?php echo ($sj[$key]); ?></span>

												<a href="/index.php/home/index/read?url=<?php echo ($a2[$key]); ?>">
											...
											<img src="<?php echo ($vo); ?>" style="width:260px; height:145px;" />
	<p style="font-size:14px"><?php echo ($a1[$key]); ?></p>
										</div>
