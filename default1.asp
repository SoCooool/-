...
<div id="default_bg">
	<div id="default_right">
		<div id="dc_show">
			...
			<div class="s_show_bg">
				<div class="s_show_l">
					<p>‧ <a href="blog.asp">日志：<%=""&eblog.setup(8,0)&""%></a></p>
			...
			<div id="menu1" style="DISPLAY: block">
				<div class="s_show_head"><span class="gaoliang"><a style="CURSOR: hand" onclick=javascript:changebar(1)>最新日志评论</A></span>&nbsp;&nbsp;&nbsp;&nbsp;<A style="CURSOR: hand" onclick=javascript:changebar(2)>最新相册评论</A></div>
				<div class="s_show_mian">
			...
			<div id="menu2" style="DISPLAY: none">
				<div class="s_show_head"><span class="gaoliang"><a style="CURSOR: hand" onclick=javascript:changebar(2)>最新相册评论</A></span>&nbsp;&nbsp;&nbsp;&nbsp;<A style="CURSOR: hand" onclick=javascript:changebar(1)>最新日志评论</A></div>
				<div class="s_show_mian">
				<div class="s_show_bg1">
	...
	<div id="default_left">
		...
		<!-- Hot日志 -->
		<div class="d_new_head"><span class="gaoliang">Hot日志</span></div>
		<div class="d_new">
			<%Dim hotlog
		...
		<div id="link">
		<div id="link_bg">
			<div id="links_head"><span class="gaoliang">友情连接</span> &nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div id="links_main">
