...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg">
	...
	<td height="30">&nbsp;&nbsp;<a href="admin_admin.asp">管理员管理首页</a> | &nbsp;<a href="admin_admin.asp?Action=Add">新增管理员</a> | &nbsp;<a href="admin_adminmodifypwd.asp">修改密码</a></td>
  </tr>
</table>
<%
if Action="Add" then
...
sub main()
	...
	sql="select * from blog_Admin order by id"
  ...
  <form name="myform" method="Post" action="admin_admin.asp" onSubmit="return confirm('确定要删除选中的管理员吗？');">
	<td>
		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="200" height="30"><input name="chkAll" type="checkbox" id="chkAll" onclick=CheckAll(this.form) value="checkbox">选中本页显示的所有管理员</td>
			<td>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
  <tr class="title">
      <td height="22" colspan="2" align="center"><strong><font color="#FFFFFF">新增管理员</font></strong></td>
  </tr>
  <tr class="tdbg"> 
  ...
  <tr class="tdbg"> 
	...
	<td width="65%" class="tdbg"><font size="2"><input type="password" name="Password"></font></td>
  </tr>
  <tr class="tdbg"> 
	<td width="35%" class="tdbg"><div align="right">确认密码：</div></td>
	<td width="65%" class="tdbg"><font size="2"><input type="password" name="PwdConfirm"></font></td>
  </tr>
  <tr class="tdbg"> 
	<td colspan="2">
		<div align="center">
...
sub DelAdmin()
	...
	if instr(UserID,",")>0 then
		...
		sql="Select * from blog_Admin where ID in (" & UserID & ")"
	else
		UserID=clng(UserID)
		sql="select * from blog_Admin where ID=" & UserID
	end if
	Set rs=Server.CreateObject("Adodb.RecordSet")
	rs.Open sql,conn,1,3
	do while not rs.eof
