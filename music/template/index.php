...
<body>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://github.com/zhizg/b" target="_blank" rel="author">官方发布</a>&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=2248186422&site=qq&menu=yes" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
