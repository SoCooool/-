...
<div class="login_box">
    ...
    <div class="login">
        ...
        <div class="lh50 tac ft_yh ft20 bg_f63 white">妃子云购系统管理</div>
	...
	<div class="input_box">
	    ...
	    <div class="lf input_value">
	        <input type="password" id="input-p" class="input_input wid280" name="password" value="" placeholder="请输入密码">
	    </div>
	    <div class="cl"></div>
	</div>
	<div>
...
<div class="copyright lh30" style="padding-top:60px;">
<a href="http://www.teyunbao.cn" target="_blank">妃子云购系统 2017最新版</a>
</div>
