...
<div id="header">
	...
	<div class="logo"></div>
<span><font color="#BE050E"  size="3">【妃子云购演示，慎防假冒盗用 - 举报有奖】免费热线: 400-6292-990 &nbsp; QQ: 185616883  &nbsp;&nbsp; 官网：www.teyunbao.cn</font></span>
    ...
    <a href="<?php echo G_WEB_PATH; ?>" title="前台首页" target="_blank">前台首页</a>
...
<div id="left">
    ...
    <ul class="left_date" id="setting">   
    	...
    	<li class="head">站点设置</li>
	               ...
	               <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/domain">手机域名绑定</a></li>	
	...
	<li class="head">站长运营</li>
     ...
     <ul class="left_date" id="content">
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/group/quanzi">论坛圈子</a></li>  
...
<div id="right">
    ...
    <a href="http://kf.teyunbao.cn/" target="_blank" class="system_button"><span><font color="red">提交工单</font></span></a>
	<a href="http://www.teyunbao.cn" target="_blank" class="system_button"><span><font color="red">云购官网</font></span></a>
            <a href="http://wpa.qq.com/msgrd?v=3&uin=185616883&site=qq&menu=yes" target="_blank" onClick="btn_map('<?php echo G_MODULE_PATH; ?>/index/map');" class="system_button"><span><font color="red">购买咨询</font></span></a>
