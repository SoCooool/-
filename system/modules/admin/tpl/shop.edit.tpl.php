	...
	<table width="100%"  cellspacing="0" cellpadding="0">
    	<tr style="background-color:#FFe;height:50px;">
			...
			<td>
				...
				单次夺宝价格	<b style="color:red"><?php echo $shopinfo['yunjiage']; ?></b>&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td width="900">
			 <input name="goods_key[pos]" value="1" type="checkbox" <?php if($shopinfo['pos']){echo "checked";} ?>/>&nbsp;推荐(新品区)&nbsp;&nbsp;
			 <input name="goods_key[renqi]" value="1" type="checkbox" <?php if($shopinfo['renqi']){echo "checked";} ?>/>&nbsp;人气（热门区）&nbsp;&nbsp; 
            </td>          
        </tr>
         <tr>
