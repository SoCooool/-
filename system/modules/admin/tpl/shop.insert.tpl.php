	...
	<table width="100%"  cellspacing="0" cellpadding="0">
		<tr>
            ...
            <select id="category" name="cateid">           
             ...
             </select> <span class="lr10">在商品分类添加栏目</span>
            </td>
		</tr>
        <tr>
			...
			<td>
				...
				</select><span class="lr10">在品牌管理添加品牌</span>
			</td>
		</tr>      
        <tr>
        ...
        <tr>      
            ...
            <td><input type="text" name="maxqishu" value="10000" class="input-text" style="width:65px; padding-left:0px; text-align:center" onKeyUp="value=value.replace(/\D/g,'')">期,	&nbsp;&nbsp;&nbsp;期数上限为65535期,每期揭晓后会根据此值自动添加新一期商品！</td>
		</tr>	
        ...
        <tr>
            ...
            <td width="900">
			 <input name="goods_key[pos]" value="1" type="checkbox" />&nbsp;推荐(新品区)&nbsp;&nbsp;
			 <input name="goods_key[renqi]" value="1" type="checkbox" />&nbsp;人气（热门区）&nbsp;&nbsp; 
            </td>          
        </tr>
       	<tr>
