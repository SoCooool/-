...
<div class="layout980 clearfix"> 
	...
	<ul class="ugoods_list">
			    <li><a target="_blank" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $go['shopid']; ?>"><img class="pic"  src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $jiexiao['thumb']; ?>"></a></li>
			                    <li class="gname" style="margin:15px 0 0 0;">
			        <a target="_blank" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $go['shopid']; ?>" class="blue"><?php echo $go['shopname']; ?></a>
			    	...
			    	<?php if($jiexiao['q_uid']): ?>
			                    <li class="yg_status" style="margin:23px 0 0 0;">幸运壕码：<br><span class="c_red"><?php echo $jiexiao['q_user_code']; ?></span></li>
				...
				<?php  else: ?>
				<li class="yg_status" style="margin:23px 0 0 0;">揭晓时间：<br><span class="c_red"><?php echo date("Y-m-d H:i:s",$jiexiao['q_end_time']); ?></span></li>
				<li class="joinInfo" style="margin:23px 0 0 0;"><p><em><?php echo $go['gonumber']; ?></em>人次</p></li>
				  <li class="do" style="margin:23px 0 0 0;"><a href=href="<?php echo WEB_PATH; ?>/goods/<?php echo $go['shopid']; ?>" class="blue" title="详情">详情</a></li>
				<?php endif; ?>			                                    
			</ul>
           <?php endif; ?>
