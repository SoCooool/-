<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="Progress-bar">
				...
				<p title="已完成<?php echo percent($item['canyurenshu'],$item['zongrenshu']); ?>"><span style="width:<?php echo percent($item['canyurenshu'],$item['zongrenshu']); ?>; display:inline-block;"></span></p>
			...
			<p class="Pro_Detsingle" style="font-size:14px;">夺宝价格：<b style="color:#999;"><?php echo $item['yunjiage']; ?></b></p>
			...
			<div id="divBuy" class="Det_button">
				...
				<a href="javascript:;" class="Det_Shopbut">立即夺宝</a>
