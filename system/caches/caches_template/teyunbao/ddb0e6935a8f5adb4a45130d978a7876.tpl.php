	...
	<ul>		
		...
		<li class="list-block">
			...
			<div class="Progress-bar">
				<p title="已完成<?php echo percent($shop['canyurenshu'],$shop['zongrenshu']); ?>"><span style="width:<?php echo percent($shop['canyurenshu'],$shop['zongrenshu']); ?>;"></span></p>
				<ul class="Pro-bar-li">
			...
			<div class="w-goods-ing">
				<div class="shop_buttom bg_red b_red1" style="margin:0 10px;width:115px;height:30px;">
					<a href="javascript:;" style="line-height:30px;font-size:14px;" class="Det_Shopnow" onclick="jwebox.goshopnow(<?php echo $shop['id']; ?>,'<?php echo WEB_PATH; ?>')">立即夺宝</a>
				</div>
				<div class="shop_buttom1 bg_pink b_pink c_red" style="margin:0px 10px;width:115px;height:30px;">
					<a href="javascript:;" onclick="gcartlist.gocartlist(<?php echo $shop['id']; ?>,'<?php echo WEB_PATH; ?>','wc_')" class="c_red" style="line-height:30px;font-size:14px;" id="car_<?php echo $shop['id']; ?>">加入购物车</a>
				</div>
			</div>
