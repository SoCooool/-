...
<div class="help-main">
	<div class="qqGroup">
		<div class="qqTitle">
			<span class="groupt">夺宝<b>QQ</b>群</span>
			<span>为打造更具公平、透明的夺宝平台，特成立各地QQ交流群（可在选择框查找本地群），欢迎广大云友加入。<br>另外，正在招募各地群主加盟，也可自建群联系客服</span>
		</div>
		<div id="listTopContents" class="qqList"><p>直属群</p>
		<ul>
		<?php $ln=1;if(is_array($lists2)) foreach($lists2 AS $v): ?>
		<li><dt>&nbsp;</dt>
		<dt><?php echo $v['name']; ?><?php if($v['full']=='已满'): ?><img src="<?php echo G_TEMPLATES_IMAGE; ?>/qqhot.gif"/><?php endif; ?></dt><dd><a href="<?php echo $v['qqurl']; ?>" style="color:#82CD4C"><?php echo $v['qq']; ?></a></dd></li>
