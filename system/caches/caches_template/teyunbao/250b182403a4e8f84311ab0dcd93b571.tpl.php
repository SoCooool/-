...
<title><?php if(isset($title)): ?><?php echo $title; ?><?php  else: ?><?php echo _cfg("web_name"); ?><?php endif; ?>_妃子云购夺宝商城系统源码-打造专业的云购夺宝商城网站！PC电脑版+WAP手机版+微信版+安卓APP+苹果APP一条龙搭建！</title>
...
<script >  
    ...
    $(window).scroll(function (){  
        ...
        if($(document).scrollTop()>temp){  
            ...
            offsetTop=34- $(document).scrollTop();  
            temp=$(document).scrollTop();  
        }  
...
<style type="text/css">
	.qrcode {
	    ...
	    bottom: 100px;
	    width: 150px;
	    background: #FFF url("../statics/templates/teyunbao/images/onlinebg.jpg") no-repeat scroll 0px 0px;
	...
	.qrcode .bd ul li .qq {
	    background: transparent url("../statics/templates/teyunbao/images//btn_qqo.png") no-repeat scroll 0% 0%;
	}
	.qrcode .bd ul li .ww {
	    background: transparent url("../statics/templates/teyunbao/images//btn_wwo.png") no-repeat scroll 0% 0%;
	}
