...
<!--banner 开始-->
<meta property="qc:admins" content="117235630645156217636" />
	...
	<?php $slides=$this->DB()->GetList("select * from `@#_slide` where 1",array("type"=>1,"key"=>'',"cache"=>0)); ?>
		...
		<div class="banner_boxR fr">
			...
			<div class="m_app bb_gray">
				<a href="/" target="_blank"><img src="<?php echo G_TEMPLATES_STYLE; ?>/images/ban.jpg" height="155" width="290"></a>
			</div>
			<div class="m_news">
	...
	<?php $ln=1;if(is_array($shopqishu)) foreach($shopqishu AS $sq): ?>
		<li class="b_gray">
			<div class="print">
				...
				<p>花费 <span class="c_red"><?php echo $sq['touzi']; ?></span> 元，获得了</p>
			...
			$("#timeloop"+data.id+" .busytime").busytime({
				callback:function($dom){
					...
					$.post(path+'/api/getshop/lottery_shop_getjson/',{gid:data.id},function(info){
						...
						uhtml+= '<p>花费 <span class="c_red">'+info.huafei+'</span>元，获得了</p>';	
...
<div class="goods_hot bt2_red w1200" style="margin-top:10px;">
	<div class="goods_hotL fl b_gray" style="border-top:0;margin-right:-1px;">
		<div class="title bb_gray br_gray" style="width:249px;"><p class="c_red">参与方法</p></div>
		<ul class="step">
			<li>
	...
	<?php $ln=1;if(is_array($go_record)) foreach($go_record AS $gorecord): ?>
		<li class="bb_gray">
		<p>用户： <a class="c_yellow" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($gorecord['uid']); ?>" target="_blank"><?php echo get_user_name($gorecord); ?></a>&nbsp;<?php echo _put_time($gorecord['time']); ?> </p>
		...
		<div class="fl li_r">
			<p>购买了 <span class="c_red"><?php echo $gorecord['gonumber']; ?></span> 人次
			 <a href="<?php echo WEB_PATH; ?>/goods/<?php echo $gorecord['shopid']; ?>" target="_blank"><span class="c_red"><?php echo _strcut($gorecord['shopname'],16); ?></span></a></p>
	...
	<div class="goods_hotR fl">
		...
		<ul class="hot_list">
			<?php $ln=1;if(is_array($shoplistrenqi)) foreach($shoplistrenqi AS $renqi): ?>
				...
				<p class="money">价值：<span class="rmb"><?php echo $renqi['money']; ?></span>  元</p>
